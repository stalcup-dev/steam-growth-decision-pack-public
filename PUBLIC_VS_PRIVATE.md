...
- Revenue ROI pack overview: `docs/REVENUE_ROI_PACK.md`

## What's private (paid client work)
- ROI engine and modeling code for net revenue impact
- Partner-only deliverables: ROI tables, refund-adjusted impact, sensitivity bands
- Region/currency breakdowns and marketing calendar integration
- Custom dashboards, experiment ops, and implementation support
